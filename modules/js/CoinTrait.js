define(['dojo', 'dojo/_base/declare'], (dojo, declare) => {
  return declare('nidavellir.coinTrait', null, {
    constructor() {
      this._notifications.push(['tradeCoin', 1500], ['discardCoin', 1000], ['ulineRecruited', 1000]);
    ...
    setupRoyalTreasure() {
      let slots = [22, 23, 24, 25, 18, 19, 20, 21, 14, 15, 16, 17, 11, 12, 13, 8, 9, 10, 5, 6, 7];
    ...
    notif_tradeCoin(n) {
      ...
      // Slide new coin
      let location =
        n.args.new.location == 'hand'
          ? 'coins-zone-' + n.args.player_id
    ...
    onEnteringStateVidofnirTransforms(args) {
      ...
      if (this.isCurrentPlayerActive()) {
        ...
        args.transformations.forEach((t) =>
          this.addPrimaryActionButton('btnVidofnir' + t, '+' + t, () => this.onClickTransformationVidofnir(t)),
        );
      }
    },
