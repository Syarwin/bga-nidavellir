...
class DwarfCard extends AbstractCard
{
  public function getTooltip()
  {
    $tooltips = [
      ...
      EXPLORER => [clienttranslate('Their Bravery Value is equal to the sum of their Bravery Points.')],
    ];
  ...
  public function updateRanks(&$ranks, $uselessExceptThrud)
  {
    if ($this->zone != NEUTRAL) {
      parent::updateRanks($ranks, $uselessExceptThrud);
    }
  }
  ...
  {
    if ($this->zone != NEUTRAL) {
      parent::updateBraveryValues($values, $player);
    }
  }
}
