...
class Vegvisir extends ArtifactCard
{
  public function __construct($row) {
    ...
    $this->name = 'Vegvisir';
    $this->tooltip = [
      clienttranslate("Immediately place this Artifact in the Explorer column of your army. Its pose can trigger the recruitment of a Hero card if it completes a rank line."),
